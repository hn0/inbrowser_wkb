...
function integrateWasmJS() {
  ...
  var wasmTextFile = Module['wasmTextFile'] || 'wkb_asm.wast';
  var wasmBinaryFile = Module['wasmBinaryFile'] || 'js/wkb_asm.wasm';
  var asmjsCodeFile = Module['asmjsCodeFile'] || 'wkb_asm.temp.asm.js';
...
memoryInitializer = Module["wasmJSMethod"].indexOf("asmjs") >= 0 || Module["wasmJSMethod"].indexOf("interpret-asm2wasm") >= 0 ? "wkb_asm.js.mem" : null;




var STATIC_BUMP = 5600;
...
var real__type = asm["_type"]; asm["_type"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__type.apply(null, arguments);
};
...
var real__convert = asm["_convert"]; asm["_convert"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__convert.apply(null, arguments);
};
...
var real__geomN = asm["_geomN"]; asm["_geomN"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return real__geomN.apply(null, arguments);
};
...
var _type = Module["_type"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_type"].apply(null, arguments) };
...
var _convert = Module["_convert"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_convert"].apply(null, arguments) };
...
var _geomN = Module["_geomN"] = function() {
  assert(runtimeInitialized, 'you need to wait for the runtime to be ready (e.g. wait for main() to be called)');
  assert(!runtimeExited, 'the runtime was exited (use NO_EXIT_RUNTIME to keep it alive after main() exits)');
  return Module["asm"]["_geomN"].apply(null, arguments) };
